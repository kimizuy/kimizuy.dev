...
import addproj1 from './addproj1.png'
import addproj2 from './addproj2.png'
import addproj3 from './addproj3.png'
import addproj4 from './addproj4.png'
import copyenvlocal from './copyenvlocal.png'
import getKey1 from './getKey1.png'
import getKey2 from './getKey2.png'
import getkey3 from './getkey3.png'
import getkey4 from './getkey4.png'
import getkey5 from './getkey5.png'
import setkeyonvercel from './setkeyonvercel.png'
import signin from './signin.png'
import signinmethod from './signinmethod.png'

export const meta = {
  title:
    'Next.js × Firebase Authentication × Vercel で認証アプリをお手軽に作ってデプロイする',
  description:
    'Next.js が用意してくれている examples のひとつである with-firebase-authentication を利用すれば、メールアドレスでの認証アプリがとても簡単に作れたのでその方法をまとめる。この記事をざっと読めば必要な環境変数の取得といった環境構築で迷わないようになると思う',
  date: { published: '2020-08-31' },
  tag: ['next', 'firebase', 'vercel'],
  image: card,
}
...
Next.js が用意してくれている examples の [with-firebase-authentication](https://github.com/vercel/next.js/tree/canary/examples/with-firebase-authentication) を利用し認証アプリをデプロイするまでを説明する。この雛形を使うため内容量としては Firebase : Vercel : Next.js = 7 : 2 : 1 くらいの比率になる。サービスやツールに全依存すればだいたいコピペとクリックでいけるぞ！
...
環境変数を設定し終わったら`yarn dev`を実行し、ローカルでメール認証ができるかどうか確認してみる。
